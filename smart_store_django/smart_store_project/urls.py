...
urlpatterns = [
    ...
    path('merchandise/detail/<User_pk>/<id>/update/', views.MerchandiseRestfulUpdate.as_view({'put': 'update'}), name='Merchandise_update'),
    path('merchandise/detail/<User_pk>/<id>/delete/', views.MerchandiseRestfulDelete.as_view({'delete': 'delete'}), name='Merchandise_delete'),
