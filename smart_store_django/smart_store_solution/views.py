...
def cookie_set(request):
    ...
    res.set_cookie('test_cookie', value=test_cookie, max_age=1000, expires=True, path='/', domain='amazonaws.com', httponly=True, secure='None', samesite='None')#httponly=True, 
